                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(
                          'Did you already select your stream?',
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 25,
...
//                          .setData({'ssc': userAnswer}, merge: true);
                      _fireBase
                          .reference()
                          .child('${authService.profile['uid']}')
                          .child('${Test.dateTime}')
                          .update({'ssc': userAnswer});
                      Navigator.popAndPushNamed(context, Satisfaction.id);
                    } else {
